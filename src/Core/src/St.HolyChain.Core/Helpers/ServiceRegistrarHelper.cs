...
internal static class ServiceRegistrarHelper
{
    internal static void AddHandlers(IServiceCollection services, HolyChainConfiguration configuration)
    {
        var assembliesToScan = configuration.AssembliesToRegister.Distinct().ToArray();

        ConnectImplementationsToTypesClosing(typeof(IHandler<,>), services, assembliesToScan, true, configuration, ServiceLifetime.Scoped);
        ConnectImplementationsToTypesClosing(typeof(IHandler<>), services, assembliesToScan, true, configuration, ServiceLifetime.Scoped);
    }
    ...
    private static void ConnectImplementationsToTypesClosing(Type openRequestInterface,
        ...
        HolyChainConfiguration configuration,
